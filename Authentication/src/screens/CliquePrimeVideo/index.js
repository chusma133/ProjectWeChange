        ...
        {videoPlayPush.map((v, i) => {
          return (
            <View style={styles.data_main} key={i}>
              ...
              /> */}
              <Video
                source={v.videoURL} // Can be a URL or a local file.
                resizeMode="cover"
                style={styles.video} // Store reference
                  ...
                  <View style={styles._user_name_main}>
                    ...
                    <View style={styles._footer}>
                      <TouchableOpacity
                        ...
                        <WithLocalSvg
                          asset={require('./../../../assets/Assets/comment.svg')}
                          width={20}
                          height={20}
                        />
                      </TouchableOpacity>
                      <TouchableOpacity style={styles._footer_icons}>
                        <WithLocalSvg
                          asset={require('./../../../assets/Assets/plant.svg')}
                          width={20}
                          height={20}
                        />
                      </TouchableOpacity>
                      <TouchableOpacity style={styles._footer_icons}>
                        <WithLocalSvg
                          asset={require('./../../../assets/Assets/tree.svg')}
                          width={20}
                          height={20}
                        />
                      </TouchableOpacity>
